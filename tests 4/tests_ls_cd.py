...
def test_ls_cd_suite(comment_file_path, student_dir):
  ...
  start_with_timeout(_test_multiple_files, comment_file_path, student_dir)
  start_with_timeout(_test_ls_directory, comment_file_path, student_dir)
  end_suite(comment_file_path)

  start_suite(comment_file_path, "Sample cd runs")
  start_with_timeout(_test_single_cd, comment_file_path, student_dir)
  start_with_timeout(_test_nested_cd, comment_file_path, student_dir)
  end_suite(comment_file_path)
  ...
  start_with_timeout(_test_ls_depth1, comment_file_path, student_dir)
  start_with_timeout(_test_ls_depth2, comment_file_path, student_dir)
  start_with_timeout(_test_ls_alternate_order, comment_file_path, student_dir)
  end_suite(comment_file_path)


  start_suite(comment_file_path, "Advanced Tests")
  # start_with_timeout(_test_deep_tree, comment_file_path, student_dir, timeout=3)
  start_with_timeout(_test_recursive_search, comment_file_path, student_dir)
  end_suite(comment_file_path)
